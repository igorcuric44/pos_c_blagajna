...
CreateWindowEx(0,
                  ...
                  ((LPCREATESTRUCT) lParam) -> hInstance,
                   NULL);
huButton1 = CreateWindowEx(BS_PUSHBUTTON,
                                   "button",
                                   "Unos",
                                   WS_CHILD | WS_VISIBLE,
                                   0,0,0,0,
                                   ...
                                   (HMENU)4,
                                     ((LPCREATESTRUCT) lParam) -> hInstance,
                                   NULL);
		huButton2 = CreateWindowEx(BS_PUSHBUTTON,
                                   "button",
                                   "Izlaz",
                                   WS_CHILD | WS_VISIBLE,
                                   0,0,0,0,
         ...
         case WM_SIZE:
         {MoveWindow(huButton1, LOWORD(lParam) / 4 - 40,HIWORD(lParam)-40, 80, 30, TRUE);
        MoveWindow(huButton2, LOWORD(lParam) / 4 + 100, HIWORD(lParam)-40, 80, 30, TRUE);
             break;     
