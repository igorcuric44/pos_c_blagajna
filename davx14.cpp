...
HWND hsSifra,hsUsluga,hsId1,hsId1_mjera,hsId1_cijena,hsPdv1,hsId2,hsId2_mjera,hsId2_cijena,hsPdv2,hskladiste1;
...
peti = CreateWindowEx(0,"sifrarnik","SIFRARNIK",WS_OVERLAPPED | WS_SYSMENU,CW_USEDEFAULT,CW_USEDEFAULT,800,550,hwnd,0,hins,0);
...
hsSifra=CreateWindowEx(0,"Edit","Sifra",WS_CHILD | WS_VISIBLE| WS_BORDER,120,10,80,30,hwnd,(HMENU)hsSIFRA,hins,NULL);
hsUsluga=CreateWindowEx(0,"Edit","Usluga",WS_CHILD | WS_VISIBLE| WS_BORDER,120,50,80,30,hwnd,(HMENU)hsUSLUGA,hins,NULL);
hsId1=CreateWindowEx(0,"Edit","Id1",WS_CHILD | WS_VISIBLE| WS_BORDER,120,90,80,30,hwnd,(HMENU)hsID1,hins,NULL);
hsId1_mjera=CreateWindowEx(0,"Edit","Id1 mjera",WS_CHILD | WS_VISIBLE| WS_BORDER,120,130,80,30,hwnd,(HMENU)hsID1_MJERA,hins,NULL);
hsId1_cijena=CreateWindowEx(0,"Edit","Id1 cijena",WS_CHILD | WS_VISIBLE| WS_BORDER,120,170,80,30,hwnd,(HMENU)hsID1_CIJENA,hins,NULL);
hsPdv1=CreateWindowEx(0,"Edit","Pdv1",WS_CHILD | WS_VISIBLE| WS_BORDER,120,210,80,30,hwnd,(HMENU)hsPDV1,hins,NULL);
hsId2=CreateWindowEx(0,"Edit","Id2",WS_CHILD | WS_VISIBLE| WS_BORDER,120,250,80,30,hwnd,(HMENU)hsID2,hins,NULL);
hsId2_mjera=CreateWindowEx(0,"Edit","Id2 mjera",WS_CHILD | WS_VISIBLE| WS_BORDER,120,290,80,30,hwnd,(HMENU)hsID2_MJERA,hins,NULL);
hsId2_cijena=CreateWindowEx(0,"Edit","Id2 cijena",WS_CHILD | WS_VISIBLE| WS_BORDER,120,330,80,30,hwnd,(HMENU)hsID2_CIJENA,hins,NULL);
hsPdv2=CreateWindowEx(0,"Edit","Pdv2",WS_CHILD | WS_VISIBLE| WS_BORDER,120,370,80,30,hwnd,(HMENU)hsPDV2,hins,NULL);
