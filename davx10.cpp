...
//lvi.iItem=1;
lvi.iItem = 0;
int res = ListView_InsertItem(hskladiste, &lvi);
cout<<res;   
ListView_SetItemText(hskladiste,res,0,items[0]);
ListView_SetItemText(hskladiste,res,1,items[1]);
ListView_SetItemText(hskladiste,res,2,items[2]);
ListView_SetItemText(hskladiste,res,3,items[3]);
ListView_SetItemText(hskladiste,res,4,items[4]);
ListView_SetItemText(hskladiste,res,5,items[5]);
res = ListView_InsertItem(hskladiste, &lvi);
cout<<res;
lvi.iItem = 1;
ListView_SetItemText(hskladiste,res,0,items[0]);
ListView_SetItemText(hskladiste,res,1,items[1]);
