...
#define hbUKUPNO 6004


HWND hblagajna,hbButton1,hbButton2,hbUkupno;
...
//SetWindowLongPtr(hbUkupno, GWLP_WNDPROC, (  LONG_PTR)ButtonProc);
...
cijena=sqlite3_column_double(res, 4);
LvItem1.iSubItem=3;         // Put in first coluom
LvItem1.pszText=LPSTR(sqlite3_column_text(res, 4));   // Text to display (can be from a char variable) (Items)
SendMessage(hblagajna,LVM_SETITEM,0,(LPARAM)&LvItem1);
...
SendMessage(hblagajna,LVM_SETITEM,0,(LPARAM)&LvItem1);
SetDlgItemText(hwnd, hbUKUPNO,LPSTR("66"));						  
cout<<iItem<<endl;
...
LvItem1.pszText=LPSTR(to_string(s).c_str());   // Text to display (can be from a char variable) (Items)
SendMessage(hblagajna,LVM_SETITEM,0,(LPARAM)&LvItem1);
SetDlgItemText(hwnd, hbUKUPNO,LPSTR("88"));
LvItem1.iSubItem=5;         // Put in first coluom
LvItem1.pszText=LPSTR(to_string(s*cijena).c_str());   // Text to display (can be from a char variable) (Items)
SendMessage(hblagajna,LVM_SETITEM,0,(LPARAM)&LvItem1);
...
//OldButtonProc1 = (WNDPROC)SetWindowLongPtr(hbUkupno, GWLP_WNDPROC, (LONG_PTR)ButtonProc);
