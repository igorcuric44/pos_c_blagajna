...
HWND hButton1,hButton2,hButton3,hButton4,hButton5,hButton6,hButton7,hButton8,hButton9,hButton10;
HWND hskladiste;
...
case WM_SIZE:
	...
	MoveWindow(hButton9, LOWORD(lParam) / 2 - 80, 420, 160, 30, TRUE);
	MoveWindow(hButton10, LOWORD(lParam) / 2 - 80, 470, 160, 30, TRUE);
...
DisplayFont = CreateFont (30, 0, 0, 0, FW_DONTCARE, false, false, false, DEFAULT_CHARSET,
                                      OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS, DEFAULT_QUALITY,
                                      DEFAULT_PITCH | FF_DONTCARE, "Consolas");
SelectObject (hPrinter, DisplayFont);
...
DisplayFont = CreateFont (40, 0, 0, 0, FW_DONTCARE, false, false, false, DEFAULT_CHARSET,
                                      ...
                                      DEFAULT_PITCH | FF_DONTCARE, "Consolas");
SelectObject (hPrinter, DisplayFont);
TextOut(hPrinter,100,x+70,"SUMA",strlen("SUMA"));
char znak[256];
sprintf(znak,"%05.2f",suma);
TextOut(hPrinter,200,x+70,znak,strlen(znak));
